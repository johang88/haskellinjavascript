...
HIJi är tänkt som ett verktyg för nybörjare att komma igång med funktionell programmering. Ur det perspektivet är HIJi än så länge en undermålig produkt. Saknaden av interaktivitet är den i dagsläget största nackdelen. Vi presenterar därför här de förbättringar som vi anser vara nödvändiga för att nybörjare ska kunna använda sig utav HIJi.
