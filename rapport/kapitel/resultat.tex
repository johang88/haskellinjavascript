...
Substitutioner är mappningar typvariabel -> typ och används av typcheckaren
...
substitutioner. En annan viktig operation är unifiering som försöker hitta en
substitution som gör två typer ekvivalenta. Om unifiering inte är möjligt
