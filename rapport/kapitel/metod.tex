...
En parser combinator består av olika funktioner som parsar olika saker exempeliv strängar, listor och blanksteg. Dessa funktioner kombineras för att skapa mer komplexa parsers.

Denna parser combinator ger oss möjlighet att enkelt implementera både den kontextfria och den del som inte är det av Haskells syntax.
